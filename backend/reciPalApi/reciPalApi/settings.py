"""
Django settings for reciPalApi project.
...
SECRET_KEY = 'django-insecure-%k*^#b@w00in!hrag4nmmd8+(afr)v4^sglz2mb#@%n++9lh!b'
...
WSGI_APPLICATION = 'reciPalApi.wsgi.application'
